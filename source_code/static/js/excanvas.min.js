if(!document.createElement("canvas").getContext){
    (function(){
        ...
        var t=Array.prototype.slice;function g(j,m,p){
        ...
        function x(j){
            ...
            switch(j.propertyName){
                case "width":i.getContext().clearRect();
        ...
        function v(j,i){
            ...
            i.font=j.font;i.textAlign=j.textAlign;
        ...
        function u(m,j){
            ...
            if(typeof m.size=="number"){
                ...
                if(m.size.indexOf("px")!=-1){
                    ...
                    if(m.size.indexOf("em")!=-1){i.size=ag*Z}
                    else{
                        if(m.size.indexOf("%")!=-1){i.size=(ag/100)*Z}
                        else{
                            if(m.size.indexOf("pt")!=-1){i.size=Z/0.75}
                            else{i.size=ag}
                        }
                    }
                }
        ...
        q.arc=function(al,aj,ak,ag,j,m){
            ...
            this.currentPath_.push({
                type:ap,x:Z.x,y:Z.y,radius:ak,xStart:ai.x,yStart:ai.y,xEnd:ah.x,yEnd:ah.y
            })
        };
                ...
                for(var ak=aj;ak<Math.min(aj+ag,this.currentPath_.length);ak++){
                    ...
                    switch(m.type){
                        case "moveTo":al=m;
                             ...
                             break;
                        case "lineTo":am.push(" l ",n(m.x),",",n(m.y));
                             break;
                        case "close":am.push(" x ");
                             m=null;
                             break;
                        case "bezierCurveTo":am.push(" c ",n(m.cp1x),",",n(m.cp1y),",",n(m.cp2x),",",n(m.cp2y),",",n(m.x),",",n(m.y));
                             break;
                        case "at":
                        case "wa":am.push(" ",m.type," ",n(m.x-this.arcScaleX_*m.radius),",",n(m.y-this.arcScaleY_*m.radius)," ",n(m.x+this.arcScaleX_*m.radius),",",n(m.y+this.arcScaleY_*m.radius)," ",n(m.xStart),",",n(m.yStart)," ",n(m.xEnd),",",n(m.yEnd));
                             break
                    }
                    if(m){
                        if(ai.x==null||m.x<ai.x){ai.x=m.x}
                        if(an.x==null||m.x>an.x){an.x=m.x}
                        if(ai.y==null||m.y<ai.y){ai.y=m.y}
                        if(an.y==null||m.y>an.y){an.y=m.y}
                    }
                }
                am.push(' ">');
                if(!ao){w(this,am)}
                else{G(this,am,ai,an)}
        ...
        q.save=function(){
            ...
            q.drawText_=function(am,ak,aj,ap,ai){
                ...
                switch(this.textBaseline){
                    case "hanging":case"top":ah.y=i.size/1.75;
                        break;
                    case "middle":break;
            ...
            U.prototype.addColorStop=function(j,i){
                ...
                function T(j,i){
                    Q(j);
                    switch(i){
                        case"repeat":case null:case"":
                            this.repetition_="repeat";
                            break;
                        case"repeat-x":case"repeat-y":case"no-repeat":
                            this.repetition_=i;
                            break;
                ...
                function Q(i){
                    if(!i||i.nodeType!=1||i.tagName!="IMG"){O("TYPE_MISMATCH_ERR")}
