...
(function(a){
    function e(h){
        ...
        if(l.elem)
            ...
            h.cursorOffsetX=l.pageX-l.left,h.cursorOffsetY=l.pageY-l.top,
        ...
        switch(h.type){
            case"mousedown":
            return a.extend(l,a(j).offset(),{elem:j,target:h.target,pageX:h.pageX,pageY:h.pageY}),
                   b.add(document,"mousemove mouseup",e,l),i(j,!1),
                   d.dragging=null,
                   !1;
    ...
    function h(){return d.dragging===!1}
    function i(a,b){
        a&&(a.unselectable=b?"off":"on",
            a.onselectstart=function(){return b},
        ...
        var b=a.event,c=b.special,
            d=c.drag={
                ...
                setup:function(c){
                    ...
                    b.add(this,"mousedown",e,c),this.attachEvent&&this.attachEvent("ondragstart",h)
                },
                teardown:function(){
    ...
    if(d.event.fixHooks)
        for(var h=c.length;h;)
            ...
            d.event.special.mousewheel={setup:function(){
                ...
                else this.onmousewheel=e},teardown:function(){
